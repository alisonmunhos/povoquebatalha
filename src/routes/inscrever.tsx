  ...
  return (
    <div className="min-h-screen bg-muted/20">
      ...
      <main className="max-w-md mx-auto px-6 py-10">
        ...
        <p className="mt-2 text-muted-foreground">Cadastre-se para receber novidades da campanha pelo WhatsApp.</p>
        <form onSubmit={onSubmit} className="mt-6 space-y-5 bg-card border rounded-xl p-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2">
              ...
              <input name="cidade" maxLength={120} className="mt-1 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" />
            </div>
            <div>
              <label className="text-sm font-medium">UF</label>
              <input name="uf" maxLength={2} className="mt-1 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" />
            </div>
          </div>
          <label className="flex items-start gap-3 text-sm">
            <input type="checkbox" name="consentimento_whatsapp" required className="mt-1 h-4 w-4" />
            <span>Autorizo receber comunicações da campanha por WhatsApp. Posso cancelar a qualquer momento respondendo "SAIR".</span>
          </label>
