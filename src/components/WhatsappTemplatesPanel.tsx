...
/**
 * Modelos aprovados pela Meta (templates oficiais) — necessários pra iniciar
 * conversas fora da janela de 24h. Extraído da antiga rota /comunicacao/templates
 * (agora um redirect) pra virar uma aba de /mensagens; a lógica do formulário
 * é a mesma de antes, só a moldura de página (header, navegação) mudou.
 */
