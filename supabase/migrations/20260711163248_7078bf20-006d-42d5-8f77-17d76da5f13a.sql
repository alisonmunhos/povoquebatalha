-- Indicador de quem iniciou a conversa (contato ou equipe). Preenchido só na
-- criação da conversa (cláusula VALUES do INSERT) e nunca alterado depois — os
-- 4 triggers abaixo nunca escrevem essa coluna no DO UPDATE SET. Conversas já
-- existentes ficam com o campo NULL (decisão: não estimar valor retroativo).
