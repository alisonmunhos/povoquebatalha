...
-- Script idempotente para completar a aplicação em um banco que já possui parte da migration.
...
DROP TRIGGER IF EXISTS trg_system_notification_settings_updated
...
DROP POLICY IF EXISTS admin_read_system_notification_settings
  ON public.system_notification_settings;
...
DROP POLICY IF EXISTS admin_manage_system_notification_settings
  ON public.system_notification_settings;
